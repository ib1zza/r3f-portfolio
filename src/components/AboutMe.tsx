...
const AboutMe = ({isVisible} : Props) => {
    return (

            <Html
                // transform
                wrapperClass={'htmlScreen ' + (isVisible ? 'visible' : 'hidden')}
                distanceFactor={1}
                position={[0, 0, -1]}
                center
            >
                ...
                <h4 className="main__title">You can reach me on:</h4>
                <div className="main__socials">

                    <a href="https://github.com/ib1zza" target="_blank" className="main__social__icon">
                    ...
                    <a href="https://vk.com/ib1zza" target="_blank" className="main__social__icon">
                    ...
                    <a href="https://t.me/ib1zza" target="_blank" className="main__social__icon">
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 496 512">
                            {/*<style>svg{fill:#ffffff}</style>*/}
                            <path
                    ...
                    <a href="mailto: dremast1337@gmail.com" target="_blank" className="main__social__icon">
